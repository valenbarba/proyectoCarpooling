...
const DATOS_DEMOSTRACION = {
  ...
  viajesDisponibles: [
    ...
    },
    {
      ...
      nombre: "Ana",
      sigla: "A",
      destino: "Kansas Pilar",
      fecha: "25 de Octubre · 19:00 hrs",
      precio: "$1800 / asiento",
      comentario: "Nos encontramos en el lote 1260 a las 18:45 en punto.",
      rating: 4.6,
      reviewsCount: 18,
    },
    {
  ...
  solicitudes: [
    {
      ...
      descripcion:
        "Valentina solicitó unirse a tu viaje hacia USAL Pilar el 2 de Octubre a las 17:00 hrs.",
      icono: FiUsers,
      viajeId: "prop-1",
      pasajero: {
        id: "pas-987",
