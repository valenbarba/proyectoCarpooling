...
const SignUp = () => {
    ...
    //Obtengo los barrios privados por api
    useEffect(() => {
    fetch(`${url}/barrios`)
        .then((res) => res.json())
    ...
    const validarFormulario = () => {
        ...
        if(!barrioSeleccionado) {
            return "Porfavor seleccione su barrio";
        }
    ...
    return(
        ...
        <FormContainer>
            ...
            <Button type="submit" className="botonSecundario">Registrarme</Button>
                
            </form>
        </FormContainer>

        <div className="divSecundario">
        <Button onClick={irALogin} className="botonPrimario">Iniciar Sesión</Button>
        </div>
